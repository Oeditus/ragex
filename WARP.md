...
The detailed, phase-by-phase development history previously embedded here
has been moved to `stuff/docs/PHASE_HISTORY.md` to keep this file focused on
actionable contributor guidance. For the authoritative, version-tagged
record of user-facing changes, see `CHANGELOG.md`.
